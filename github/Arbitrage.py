...
from scripts.function import append_new_line
...
def get_sport():
    ...
    append_new_line(r'all.txt', str(odds_response))
    
    return odds_response;


def run():
    odds_response = get_sport()
    ...
    writer.save()"""
    writer = pd.ExcelWriter("bets.xlsx", engine="xlsxwriter")
