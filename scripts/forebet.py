...
from function import analys_per_link, append_new_line, forebet, forebet_per_page, forebet_scrap, forebet_scrap_trend, save_to_excel, scrap_selenium_v1, cleaner
